        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Credit = table.Column<string>(unicode: false, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberSetsUsed = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DBBC", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DBBC_ToUser",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DBBCId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DBBCTOUSER", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Table_ToDBBC",
                        column: x => x.DBBCId,
                        principalTable: "DBBC",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Table_ToUser",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DBBC_TeacherId",
                table: "DBBC",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_DBBCTOUSER_DBBCId",
                table: "DBBCTOUSER",
                column: "DBBCId");

            migrationBuilder.CreateIndex(
                name: "IX_DBBCTOUSER_UserId",
                table: "DBBCTOUSER",
                column: "UserId");
        }
